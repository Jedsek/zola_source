...
<figcaption class="fold"> ~/.config/hypr/hyprland.conf </figcaption>
...
具体效果你可以看官网解释, 很详细, 所以我拒绝再抄一遍并翻译一遍  
...
<figcaption class="fold"> ~/.config/hypr/keybindings.conf </figcaption>
