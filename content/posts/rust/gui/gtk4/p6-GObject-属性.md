...
{{ video(src="/images/rust/gtk4/bidirectional_switches.webm" scale=0.2) }}
...
{% code(path="src/custom_button/imp.rs") %}
```rust
...
{{ video(src="/images/rust/gtk4/transform_buttons.webm" scale=0.2) }}
