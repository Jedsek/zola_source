...
其实我是一只会咕咕叫的肥美鸽子, 虽然写博客好麻烦, 但我还是尽量保持更新吧? 只要有空? ~~(应该吧)~~ :)  
请根据需要选择文章, 善用右侧的目录功能可以进行 **传送**,  记好了 ~~(传送魔法我只教你这么一次哦!)~~  

有一些文章难度比较大, 资料也缺乏, 整理起来费时费力, 鉴于个人能力正在缓慢学习ing  
以下大部分文章还是我高中时期写的, 像是 haskell 之类的系列理所当然地被鸽掉了!!!  

<br/>

**关于每行前面框框的说明:**  
- [x] <--这个表示以下情况之一: <span class="text-[lightpink]">写完了</span> or <span class="text-[lightblue]">该系列文章间关联不大随缘更新</span>  
...
关于文本/代码的编辑(器)方面的一些技术, 介绍一些喜欢的编辑器  
顺带翻译一些杂七杂八的博客文章  

- [x] [Zed's blog](/categories/zed-blog-translation) (博文翻译)  
- [ ] [Helix 编辑器](/categories/helix-editor) (一个用 rust 编写的后现代编辑器)  
...
- [ ] [高中的信息技术学科课程](/categories/high-school-it)
